package cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.app;
...
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.camera.IntentUtils;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.camera.TConstant;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.camera.TImageFiles;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.camera.TUriParse;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.camera.TUtils;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.compress.CompressConfig;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.compress.CompressImage;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.compress.CompressImageImpl;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.model.CropOptions;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.model.TContextWrap;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.model.TException;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.model.TExceptionType;
import cn.com.xibeiuniversity.xibeiuniversity.function.takephoto.model.TIntentWap;
...
//        if (options.isWithOwnCrop()){//如果true就自带工具裁剪，否则就第三方，因为没有第三方所以注视掉，有的话再加入
//            TUtils.cropWithOwnApp(contextWrap,imageUri,outPutUri,options);
//        }else {
//        }
        TUtils.cropWithOtherAppBySafely(contextWrap, imageUri, outPutUri, options);//第三方的方式裁剪图片
    }
